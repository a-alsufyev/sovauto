...
export const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'footer.curated_prefix': 'Developed at ',
    'footer.curated_suffix': ' • Historical Archive 1.0.3',
  ...
  ru: {
    ...
    'footer.curated_prefix': 'Разработано в ',
    'footer.curated_suffix': ' • Исторический архив 1.0.3',
  ...
  de: {
    ...
    'footer.curated_prefix': 'Entwickelt in ',
    'footer.curated_suffix': ' • Historisches Archiv 1.0.3',
  ...
  es: {
    ...
    'footer.curated_prefix': 'Desarrollado en ',
    'footer.curated_suffix': ' • Archivo histórico 1.0.3',
